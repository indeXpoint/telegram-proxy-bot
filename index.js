...
const BOTS = {
  ...
  botAI: process.env.BOT_TOKEN_AI,
  botAJ: process.env.BOT_TOKEN_AJ,
  botAK: process.env.BOT_TOKEN_AK,
  botAL: process.env.BOT_TOKEN_AL,
  botAM: process.env.BOT_TOKEN_AM,
  botAN: process.env.BOT_TOKEN_AN,
  botAO: process.env.BOT_TOKEN_AO,
  botAP: process.env.BOT_TOKEN_AP,
  botAQ: process.env.BOT_TOKEN_AQ,
  botAR: process.env.BOT_TOKEN_AR,
  botAS: process.env.BOT_TOKEN_AS,
  botAT: process.env.BOT_TOKEN_AT,
  botAU: process.env.BOT_TOKEN_AU,
  botAV: process.env.BOT_TOKEN_AV,
  botAW: process.env.BOT_TOKEN_AW,
