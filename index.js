...
const BOTS = {
  ...
  botH: process.env.BOT_TOKEN_H,
  botI: process.env.BOT_TOKEN_I,
  botJ: process.env.BOT_TOKEN_J,
  botK: process.env.BOT_TOKEN_K,
  botL: process.env.BOT_TOKEN_L,
  botM: process.env.BOT_TOKEN_M,
  botN: process.env.BOT_TOKEN_N,
  botO: process.env.BOT_TOKEN_O,
  botP: process.env.BOT_TOKEN_P,
  botQ: process.env.BOT_TOKEN_Q,
  botR: process.env.BOT_TOKEN_R,
  botS: process.env.BOT_TOKEN_S,
  botT: process.env.BOT_TOKEN_T,
  botU: process.env.BOT_TOKEN_U,
  botV: process.env.BOT_TOKEN_V,
  botW: process.env.BOT_TOKEN_W,
  botX: process.env.BOT_TOKEN_X,
  botY: process.env.BOT_TOKEN_Y,
  botZ: process.env.BOT_TOKEN_Z,
  botAA: process.env.BOT_TOKEN_AA,
  botAB: process.env.BOT_TOKEN_AB,
  botAC: process.env.BOT_TOKEN_AC,
  botAD: process.env.BOT_TOKEN_AD,
  botAE: process.env.BOT_TOKEN_AE,
  botAF: process.env.BOT_TOKEN_AF,
  botAG: process.env.BOT_TOKEN_AG,
  botAH: process.env.BOT_TOKEN_AH,
  botAH: process.env.BOT_TOKEN_AI,
  botAH: process.env.BOT_TOKEN_AJ,
  botAH: process.env.BOT_TOKEN_AK,
  botAH: process.env.BOT_TOKEN_AL,
  botAH: process.env.BOT_TOKEN_AM,
  botAH: process.env.BOT_TOKEN_AN,
  botAH: process.env.BOT_TOKEN_AO,
  botAH: process.env.BOT_TOKEN_AP,
  botAH: process.env.BOT_TOKEN_AQ,
  botAH: process.env.BOT_TOKEN_AR,
  botAH: process.env.BOT_TOKEN_AS,
  botAH: process.env.BOT_TOKEN_AT,
  botAH: process.env.BOT_TOKEN_AU,
  botAH: process.env.BOT_TOKEN_AV,
  botAH: process.env.BOT_TOKEN_AW,
  botAH: process.env.BOT_TOKEN_AX,
  botAH: process.env.BOT_TOKEN_AY,
  botAH: process.env.BOT_TOKEN_AZ,
};
